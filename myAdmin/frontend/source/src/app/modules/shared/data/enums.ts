...
export enum MobileRegistrationStatusSummary {
    New = "New",
	Inactive = "Inactive",
    PendingResolution = "PendingResolution",
    Disabled = "Disabled",
...
export enum CancelDeviceReplacementAction {
	PreviousDeviceActive = "PreviousDeviceActive",
	OptOut = "OptOut"
}
...
export const MobileRegistrationStatusSummaryValue = new Map<MobileRegistrationStatusSummary, number>([
	[MobileRegistrationStatusSummary.New, 0],
	[MobileRegistrationStatusSummary.Inactive, 1],
	[MobileRegistrationStatusSummary.PendingResolution, 2],
	[MobileRegistrationStatusSummary.Disabled, 3],
	[MobileRegistrationStatusSummary.Locked, 4],
	[MobileRegistrationStatusSummary.Complete, 5],
]);
...
export const CancelDeviceReplacementActionValue =
	new Map<CancelDeviceReplacementAction, number>([
		[CancelDeviceReplacementAction.PreviousDeviceActive, 0],
		[CancelDeviceReplacementAction.OptOut, 1]
	]);
...
export const ChannelIndictorValues = new Map<string, string>([
	["AG", "Agency"],
	["DI", "Direct"],
	["IN", "Direct"],
	["", ""]
