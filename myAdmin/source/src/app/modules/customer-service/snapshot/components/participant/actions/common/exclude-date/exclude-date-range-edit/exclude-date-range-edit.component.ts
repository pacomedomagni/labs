...
@Component({
    selector: "tmx-snapshot-exclude-date-range-edit",
    templateUrl: "./exclude-date-range-edit.component.html",
    styleUrls: ["./exclude-date-range-edit.component.scss"],
    standalone: false
})
export class ExcludeDateRangeEditComponent implements OnInit, AfterViewInit {
