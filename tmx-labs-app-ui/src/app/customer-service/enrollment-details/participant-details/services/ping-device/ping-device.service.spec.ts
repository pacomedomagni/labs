...
describe('PingDeviceService', () => {
    ...
    beforeEach(() => {
        ...
        const participantDetailsFormattingServiceSpy = jasmine.createSpyObj(
        ...
        TestBed.configureTestingModule({
            providers: [
                ...
                { provide: NotificationBannerService, useValue: notificationServiceSpy },
                {
                    ...
                    useValue: participantDetailsFormattingServiceSpy,
                },
        ...
        participantDetailsFormattingService = TestBed.inject(
            ParticipantDetailsFormattingService,
        ) as jasmine.SpyObj<ParticipantDetailsFormattingService>;
        mockResourceMessageService = TestBed.inject(
        ...
        participantDetailsFormattingService.formatVehicleNickname.and.returnValue(
            mockParticipantDisplay,
        );
    ...
    describe('openPingDeviceDialog', () => {
        it('should format vehicle nickname and open confirmation dialog with correct parameters', () => {
            ...
            service
                .openPingDeviceDialog(mockDeviceSerialNumber, mockVehicle, mockNickName)
                .subscribe();

            expect(participantDetailsFormattingService.formatVehicleNickname).toHaveBeenCalledWith(
                mockVehicle,
                mockNickName,
            );
        ...
        it('should ping device when user confirms the dialog', (done) => {
            const mockApiResponse: Resource = {
                extenders: [],
                messages: {
                    statusDescription: 'Device pinged successfully',
                },
            };
            ...
            service
                ...
                .subscribe((result) => {
                    ...
                    expect(mockDeviceService.pingDevice).toHaveBeenCalledWith(
    ...
    describe('pingDevice (private method testing through openPingDeviceDialog)', () => {
        ...
        it('should show success notification when ping succeeds with StatusDescription message', (done) => {
            const mockApiResponse: Resource = {
                extenders: [],
                messages: { statusDescription: 'Device ping successful' },
            };
    ...
    describe('Integration scenarios', () => {
        it('should complete full ping flow with success', (done) => {
            const mockApiResponse: Resource = {
                extenders: [],
                messages: { statusDescription: 'Device successfully pinged' },
            };
            ...
            service
                ...
                .subscribe((result) => {
                    ...
                    expect(
                        participantDetailsFormattingService.formatVehicleNickname,
                    ).toHaveBeenCalledWith(mockVehicle, mockNickName);
