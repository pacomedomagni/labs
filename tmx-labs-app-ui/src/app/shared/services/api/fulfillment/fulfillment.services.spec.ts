...
describe('FulfillmentService', () => {
  ...
  const mockOrderListDetails: OrderListDetails = {
    deviceOrders: [
      { pdeviceOrderSeqID: 1, nbrDevicesNeeded: 3, name: 'John Doe', email: 'john@example.com' },
      { pdeviceOrderSeqID: 2, nbrDevicesNeeded: 2, name: 'Jane Smith', email: 'jane@example.com' }
    ],
