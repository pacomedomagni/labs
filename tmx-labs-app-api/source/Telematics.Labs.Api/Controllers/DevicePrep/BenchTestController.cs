...
namespace Progressive.Telematics.Labs.Api.Controllers.DevicePrep
{
    [Route("Api/BenchTest")]
    public class BenchTestController : TelematicsController<IBenchTestOrchestrator>
    {
        ...
        [ProducesResponseType(typeof(Resource), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<Resource> AddBenchTest([FromBody][Required] Progressive.Telematics.Labs.Business.Resources.Resources.BenchTest.AddBenchTestRequest request)
        {
