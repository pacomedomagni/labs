...
using Moq;
using Progressive.Telematics.Admin.Business.Mappers;
...
public class Services
{
    ...
    public Mock<IDeviceService> Device { get; set; }
    public Mock<IDeviceActivityService> DeviceActivity { get; set; }
    ...
    public Mock<IRolloutHelper> RolloutHelper { get; set; }
}

public class Apis
{
    public Mock<IClaimsParticipantManagementApi> ClaimsParticipantManagement { get; set; }
    public Mock<ICommonApi> Common { get; set; }
    public Mock<IDeviceApi> Device { get; set; }
    public Mock<IHomebaseParticipantManagementApi> HomebaseParticipantManagement { get; set; }
    public Mock<IPolicyApi> Policy { get; set; }
    public Mock<IPolicyDeviceApi> PolicyDevice { get; set; }
    public Mock<IPolicyTripApi> PolicyTrip { get; set; }
    ...
    public Mock<IClaimsRegistrationApi> ClaimsRegistration { get; set; }
}
...
public abstract class TestBase<T, T2>
{
    ...
    private void MockApis()
    {
        Apis = new Apis
        {
            ...
            ClaimsRegistration = new Mock<IClaimsRegistrationApi>()
        };
    }
    ...
    private void MockServices()
    {
        Services = new Services
        {
            ...
            Device = new Mock<IDeviceService>(),
            DeviceActivity = new Mock<IDeviceActivityService>(),
            DeviceLot = new Mock<IDeviceLotService>(),
            Participant = new Mock<IParticipantService>(),
            Policy = new Mock<IPolicyService>(),
            ...
            RolloutHelper = new Mock<IRolloutHelper>()
        };
    }
